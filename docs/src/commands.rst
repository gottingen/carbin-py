...
.. option::  -p, --prefix PATH      
    ...
    Set prefix where packages are installed. This defaults to a directory named ``carbin`` in the current working directory. This can also be overidden by the ``CARBIN_PREFIX`` environment variable.
